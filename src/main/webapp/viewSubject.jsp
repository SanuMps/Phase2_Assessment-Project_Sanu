...
<tr>
<td>Class ID </td><td><input type="number" name="classID" placeholder="Class ID"></td>
</tr>
<tr>
  <td>Teacher ID </td><td><input type="number" name="teacherID" placeholder="Teacher ID"></td>
</tr>
<tr>
