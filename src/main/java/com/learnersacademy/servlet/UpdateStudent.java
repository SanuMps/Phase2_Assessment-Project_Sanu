...
public class UpdateStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session!=null) {
			try {
				System.out.print(" hehe"+request.getParameterMap());
				...
				System.out.println("Lion"+student);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session!=null) {
			try {
				System.out.println("Snake "+request.getParameter("classID"));
				...
				student.setStudentDOB((date));}
				System.out.println("UpdateStd"+student);
				student.setClassID(Integer.valueOf(Integer.parseInt(request.getParameter("classID"))));
