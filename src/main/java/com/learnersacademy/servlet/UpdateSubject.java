	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session!=null) {
			try {
				...
				subject.setClassId(Integer.valueOf(Integer.parseInt(request.getParameter("classID"))));
				subject.setTeacherId(Integer.valueOf(Integer.parseInt(request.getParameter("teacherID"))));
				System.out.println("Class: "+Integer.valueOf(Integer.parseInt(request.getParameter("classID"))));
				System.out.println("Teacher: "+Integer.valueOf(Integer.parseInt(request.getParameter("teacherID"))));
